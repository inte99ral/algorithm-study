...
| 대기       | [SWEA 20671](./Problem/Failed/SWEA/D5/SWEA_20671/__숫자_카드__.md)                   | 숫자 카드         | `#D5`           |
| 대기       | [PG 181186](./Problem/failed/Programmers/Level_3/PG_181186/__아방가르드_타일링__.md) | 아방가르드 타일링 | `#Level_3`      | `#`      |
...
| :--------- | :-------------------------------------------------------------------------- | :-------------- | :-------------- | :------- |
| 예시-xx-xx | [BJ xxxx](./Problem/__X_X__.md)                                             | X X             | `#Level_DⅠⅡⅢⅣⅤ` | `#태그`  |
| 시도 중... | [PG 42627](https://school.programmers.co.kr/learn/courses/30/lessons/42627) | 디스크 컨트롤러 | `#Level_3`      | `#태그`  |
